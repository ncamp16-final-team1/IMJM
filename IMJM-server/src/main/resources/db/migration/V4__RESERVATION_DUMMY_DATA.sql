...
values
    ...
    ('SALON001', '커트', '여성커트', '여성전용커트입니다.', 22000),
    ('SALON001', '커트', '아이커트', '아이전용커트입니다.', 10000),
    ('SALON001', '염색', '남성염색', '남성염색입니다.', 50000),
    ('SALON001', '염색', '여성염색', '여성염색입니다.', 80000),
    ('SALON001', '염색', '아이염색', '아이염색입니다.', 20000);

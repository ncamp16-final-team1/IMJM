...
export default function ViewReview() {
    ...
    useEffect(() => {
        ...
        const fetchReview = axios.get(`/api/mypages/view-review`, {
            params: { reviewId }
        })
        .then(response => {
        ...
        const fetchReply = axios.get(`/api/mypages/view-review-reply`, {
            params: { reviewId }
        })
        .then(response => {
            if (response.data) {
    ...
    const handleDeleteReview = () => {
        ...
        axios.delete(`/api/mypages/review/${reviewData.reviewId}`)
        .then(() => {
    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', mb: 3 }}>
                <Box sx={{ flexGrow: 1 }}>
                <Typography variant="h5" fontWeight="bold">{salonName}</Typography>
            ...
            {loading ? (
                ...
                <Stack 
                    ...
                    sx={{ mb: 2 }}
                >
                    <Typography variant="h6" sx={{ fontWeight: 'bold' }}>내가 작성한 리뷰</Typography>
                    <Typography 
                    variant="body2" 
            ...
            <Box sx={{ mt: 2, mb: 2 }}>
                ...
                sx={{ mb: 0 }}
                >
                  <Typography variant="h6" sx={{ fontWeight: 'bold' }}>살롱 리뷰 답변</Typography>
                </Stack>

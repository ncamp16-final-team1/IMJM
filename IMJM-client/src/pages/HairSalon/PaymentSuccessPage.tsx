...
const completePayment = useCallback(async (
  ...
  try {
    ...
    if (approveResponse.data.success) {
      ...
      console.log("세션 스토리지에서 임시 예약 정보 삭제 완료");
  ...
  // 결제 처리 실행
  // PaymentSuccessPage.tsx의 useEffect 함수 수정
  useEffect(() => {
  ...
  }, [paymentKey, orderId, amount, completePayment]);
  ...
  // 마이페이지 이동 함수
  const goToMyPage = () => navigate("/my/appointments");
